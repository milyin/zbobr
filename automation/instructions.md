...
**From Copilot CLI:**
```bash
copilot --agent worker --model gpt-5-mini -i "Fix issue #123 in your-domain-project."
```

**From GitHub Copilot Chat:**
```
@worker fix issue #123
```
...
- **update_issue_with_plan.sh** — Appends a plan file to an issue body under an 'Implementation plan' header and sets the issue milestone to PENDING.
  ...
  - Example: `automation/scripts/update_issue_with_plan.sh org/copilot-zenoh 1 /path/to/plan.md`
