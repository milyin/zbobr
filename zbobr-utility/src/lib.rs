...
/// Lists are always replaced wholesale: if the overlay provides any entries they replace the base.
...
macro_rules! merge_toml_scalar {
    ($($t:ty),*) => {
        $(
            impl MergeToml for $t {
                fn merge_toml(self, other: Self) -> Self {
                    other
                }
            }
...
merge_toml_scalar!(bool, u8, u16, u32, u64, usize, i8, i16, i32, i64, isize, f32, f64, String);
