...
- main:1:**planning** `claude` `claude-sonnet-4.6` `2026-03-28 16:08:51 +0100`
  ...
  - [ ] Fix indentation in MdStage renderer and parser <sub>[ctx_rec_2](https://github.com/milyin/zbobr/blob/reports/reports/task_232/checklist_main_1_planning_item.md)</sub>
