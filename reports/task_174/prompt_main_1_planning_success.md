...
when performing technical commits with full reports, mention the original task in non-github format (e.g. separate # and number) to about polluting git log with useless references
...
Configured worktree with postfix no-issue-refs-in-commits

[report_main_1_preparing_success.md](https://github.com/milyin/zbobr/blob/reports/reports/task_174/report_main_1_preparing_success.md)
