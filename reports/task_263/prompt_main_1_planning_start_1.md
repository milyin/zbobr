...
Also do not assign `ctx_rec_{}` for records without links, their only purpose is to fetch link's content.
...
- planning
  - 💬 Plan: remove DeleteCtxRec action and hide ctx_rec_ for linkless records [ctx_rec_1]
