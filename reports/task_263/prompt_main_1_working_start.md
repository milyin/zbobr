...
- planning
  - ✅ Plan ready: remove DeleteCtxRec tool and suppress ctx_rec IDs for non-interactive records in prompt mode [ctx_rec_5]
    - [ ] Remove DeleteCtxRec from McpTool enum and role configs [ctx_rec_2]
    - [ ] Remove delete_ctx_rec MCP handler and supporting code [ctx_rec_3]
    - [ ] Suppress ctx_rec IDs for non-interactive records in prompt mode [ctx_rec_4]
