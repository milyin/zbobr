...
- planning
  - ✅ Plan approved. Append instance name to workspaces and repos_dir at the wiring po [ctx_rec_6]
    - [ ] Append instance to workspaces and repos_dir paths in commands.rs wiring point [ctx_rec_3]
    - [ ] Update test environment to apply instance to workspaces and repos_dir paths [ctx_rec_4]
    - [ ] Run cargo test and cargo clippy to verify no regressions [ctx_rec_5]
