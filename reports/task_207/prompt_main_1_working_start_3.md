...
- main:1:**planning** `claude` `claude-sonnet-4.6` <sub>2026-03-28 11:36:01 +0100</sub>
  ...
  - [ ] Remove old-format backward compatibility parsing from stage_title.rs <sub>[ctx_rec_20](https://github.com/milyin/zbobr/blob/reports/reports/task_207/checklist_main_1_planning_item_4.md)</sub>
