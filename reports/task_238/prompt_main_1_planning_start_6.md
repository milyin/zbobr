...
- skynet:main:1:**planning** `claude` `claude-sonnet-4.6` `2026-03-29 15:25:17 +0200`
    - [ ] Implement Secret struct in zbobr-utility <sub>[ctx_rec_11](https://github.com/milyin/zbobr/blob/reports/reports/task_238/checklist_main_1_planning_item_4.md)</sub>
    - [ ] Update zbobr-api: remove old secret.rs, re-export from zbobr-utility <sub>[ctx_rec_12](https://github.com/milyin/zbobr/blob/reports/reports/task_238/checklist_main_1_planning_item_5.md)</sub>
    - [ ] Update validate() methods to &mut self and fix construction callsites <sub>[ctx_rec_13](https://github.com/milyin/zbobr/blob/reports/reports/task_238/checklist_main_1_planning_item_6.md)</sub>
<!-- stage -->
