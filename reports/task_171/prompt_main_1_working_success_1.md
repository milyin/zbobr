...
Implementation incomplete: backend support for error field missing, stop_with_error logic not updated, tests not updated.

[report_main_1_reviewing_failure.md](https://github.com/milyin/zbobr/blob/reports/reports/task_171/report_main_1_reviewing_failure.md)
