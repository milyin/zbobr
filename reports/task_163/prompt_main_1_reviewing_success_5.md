...
Fixed StageInfo: pipeline String→Pipeline, stage String→Stage, added run_id: u64. All 23 zbobr-api tests pass. Pre-existing github backend build error (missing `context` field) is unrelated.

[report_main_1_working_success_1.md](https://github.com/milyin/zbobr/blob/reports/reports/task_163/report_main_1_working_success_1.md)
