...
Completed update-backends checklist item. Both GitHub and FS backends now use TaskContext instead of checklist. GitHub backend's issue_to_task returns Result and extracts context from parse_description_full. FS backend's TaskFile struct uses context: TaskContext. All test helpers across the codebase updated. All 123 tests pass.

[report_main_1_working_report.md](https://github.com/milyin/zbobr/blob/reports/reports/task_163/report_main_1_working_report.md)
