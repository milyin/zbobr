...
Implementation is incomplete. `TaskContext` structures added but `checklist` not removed from `Task`. Backends, MCP, and prompts not updated.

[report_main_1_reviewing_failure_2.md](https://github.com/milyin/zbobr/blob/reports/reports/task_163/report_main_1_reviewing_failure_2.md)
