...
Implementation is incomplete. Only core data structures in `zbobr-api` are implemented. Backends, dispatcher, and tools are untouched.

[report_main_1_reviewing_failure.md](https://github.com/milyin/zbobr/blob/reports/reports/task_163/report_main_1_reviewing_failure.md)
