...
Implemented all 4 checklist items: added `ensure_label_exists()` helper that ignores 422 errors, integrated it into `apply_state_change()` for dynamic label creation, fixed `state:pending` color from lavender to gray. All tests pass, no new clippy warnings.

[report_main_1_working_success_1.md](https://github.com/milyin/zbobr/blob/reports/reports/task_158/report_main_1_working_success_1.md)
