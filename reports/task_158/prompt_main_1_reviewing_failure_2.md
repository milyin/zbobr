...
Added State::LABEL_DONE/PAUSE/READY/PENDING/RUNNING constants, ALL_LABEL_NAMES array, and label_name() method to zbobr-api/src/task.rs. Follows Pipeline::MAIN/MERGE + as_str() pattern. 3 tests added, all pass, full project compiles.

[report_main_1_working_success_2.md](https://github.com/milyin/zbobr/blob/reports/reports/task_158/report_main_1_working_success_2.md)
