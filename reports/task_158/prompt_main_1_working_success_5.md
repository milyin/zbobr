...
Implementation violates API cleanliness request and misses documentation updates.

[report_main_1_reviewing_failure_3.md](https://github.com/milyin/zbobr/blob/reports/reports/task_158/report_main_1_reviewing_failure_3.md)
