...
Replaced milestone-based state storage with label-based storage in github.rs. Added state_to_labels(), labels_to_state(), state_label_color() conversion functions. Rewrote apply_state_change to use labels (state:/pipeline:/stage: prefixes). Updated issue_to_task and setup(). Removed all milestone code. All 96 tests pass.

[report_main_1_working_success.md](https://github.com/milyin/zbobr/blob/reports/reports/task_158/report_main_1_working_success.md)
