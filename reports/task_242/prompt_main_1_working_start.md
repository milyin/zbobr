...
- main:1:**planning** `claude` `claude-sonnet-4.6` `2026-03-28 21:39:36 +0100`
    ...
    - [ ] Add `allowed_usernames` field to `ZbobrTaskBackendGithubConfig` <sub>[ctx_rec_1](https://github.com/milyin/zbobr/blob/reports/reports/task_242/checklist_main_1_planning_item.md)</sub>
    - [ ] Add `IssueUser` struct and `user` field to `IssueResponse` <sub>[ctx_rec_2](https://github.com/milyin/zbobr/blob/reports/reports/task_242/checklist_main_1_planning_item_1.md)</sub>
    - [ ] Filter issues by `allowed_usernames` in `list_tasks` <sub>[ctx_rec_3](https://github.com/milyin/zbobr/blob/reports/reports/task_242/checklist_main_1_planning_item_2.md)</sub>
    - [ ] Update `init.rs` default config template <sub>[ctx_rec_4](https://github.com/milyin/zbobr/blob/reports/reports/task_242/checklist_main_1_planning_item_3.md)</sub>
