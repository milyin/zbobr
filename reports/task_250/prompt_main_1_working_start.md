...
- planning
  - ✅ Plan approved. 6 checklist items created for implementation: add "drudge" tool, add "linting" stage, add "linter" role, create LINTER_PROMPT, update TESTER_PROMPT, update tests. [ctx_rec_8]
    - [ ] Add "drudge" tool definition in default_config_toml() [ctx_rec_2]
    - [ ] Add "linting" stage to main pipeline before "testing" [ctx_rec_3]
    - [ ] Add "linter" role definition [ctx_rec_4]
    - [ ] Create LINTER_PROMPT constant and register in PROMPT_FILES [ctx_rec_5]
    - [ ] Update TESTER_PROMPT to exclude formatting/linting [ctx_rec_6]
    - [ ] Update tests for new linter stage and prompt [ctx_rec_7]
