...
- planning
  - ✅ Plan approved and checklist created for multi-config support implementation. [ctx_rec_7]
    - [ ] Change ConfigFileArg to accept multiple config paths with -c shortcut [ctx_rec_2]
    - [ ] Add merge_toml method to Toml structs via config_struct macro [ctx_rec_3]
    - [ ] Update resolve_config_location for multiple paths [ctx_rec_4]
    - [ ] Merge multiple configs in main.rs loading flow [ctx_rec_5]
    - [ ] Update all callers of ConfigFileArg and resolve_config_location [ctx_rec_6]
