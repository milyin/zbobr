...
- working
    - [ ] Add map_inner_types helper to macro and generate key-wise merge for map fields i [ctx_rec_18]
    - [ ] Fix WorkflowToml::merge_toml to merge roles and pipelines key-by-key [ctx_rec_19]
    - [ ] Add tests for map-like field merging: overlapping and non-overlapping keys prese [ctx_rec_20]
- working
...
- working
  - ✅ Fixed recursive merge for same-key map entries: ProviderDefinition, RoleDefiniti [ctx_rec_26]
    - [ ] Add tests for partial same-key overlays (partial patch within a named entry) [ctx_rec_24]
