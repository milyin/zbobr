...
- planning
  - ✅ Comprehensive understanding of TOML config merging testing patterns found and do [ctx_rec_9]
    - [ ] Add TOML deserialization round-trip tests for Option<Vec> fields [ctx_rec_10]
    - [ ] Add tools map merge test (IndexMap<String, Vec<ToolEntry>> key-wise merge) [ctx_rec_11]
    - [ ] Add end-to-end multi-config merge test from TOML strings [ctx_rec_12]
