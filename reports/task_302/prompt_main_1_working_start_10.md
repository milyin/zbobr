...
- working
  - ✅ Fixed MCP fallback regression: restored ALL_TOOLS default when role.mcp is None [ctx_rec_17]
    - [x] Fix MCP fallback regression: restore ALL_TOOLS default when role.mcp is None in [ctx_rec_16]
- reviewing
  - ❌ Blocking regression remains: omitted role.mcp now disables MCP tools at runtime [ctx_rec_18]
